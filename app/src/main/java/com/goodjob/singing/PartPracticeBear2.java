...
public class PartPracticeBear2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_part_practice_bear2);
        ...
        pitchbutton4 = findViewById(R.id.pitchbutton5);
        pitchbutton5 = findViewById(R.id.pitchbutton6);
        pitchbutton6 = findViewById(R.id.pitchbutton7);
        ...
        playVib.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                long[] pattern = {100, 100, 150, 100, 150, 100, 400, 100, 150, 100, 150, 100, 400, 100, 400, 100, 400, 100, 900 };
        ...
        next.setOnClickListener(new View.OnClickListener() { //다음마디
            ...
            public void onClick(View v) {
                Intent intent = new Intent (
                        getApplicationContext(), PartPracticeBear3.class);
