...
public class PartPracticeODS2 extends AppCompatActivity {
    ...
    float D, F, G, A, B, highC;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_part_practice_ods2);
        ...
        playVib.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                long[] pattern = {100, 100, 150, 100, 150, 100, 150, 100, 150, 100, 150, 100, 150, 100, 900};
