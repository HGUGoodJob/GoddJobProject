...
public class PartPracticeODS7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_part_practice_ods7);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent (
                        getApplicationContext(), PartPracticeODS8.class);
       ...
       if (sex.equals("man")) { //남성음역대 (옥타브3)솔
            B = 124.000f; // 시
            C = 131.000f; // 도
            D = 147.000f; // 레
            E = 165.000f; // 미
