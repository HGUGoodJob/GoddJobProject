...
public class PartPracticeODS5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_part_practice_ods5);
        ...
        playVib.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                long[] pattern = {100, 100, 400, 100, 400, 100, 400, 100, 650, 100, 150, 100, 400};
